#title:
#description: the file will include all the charts derived from shot-data
#inputs:
#outputs:
library(ggplot2)
library(grid)
...
grid.arrange(draymond_green_shot_chart, klay_thompson_shot_chart, andre_iguodala_shot_chart, stephen_curry_shot_chart, kevin_durant_shot_chart, ncol = 3, as.table = FALSE)
